...
<head>
    ...
    <script type="text/javascript">
        ...
        function countOpen() {
            var url = "h5/share/click?userId=" + uid + "&shareType=2";//shareType： 1 商城；2 APP
            console.log(url);
            $.ajax({
                url: url,
                type: "GET",
        ...
        function getName() {
            var url = "h5/share/detail?userId=" + uid;
            $.ajax({
                url: url,
                type: "GET",
                dataType: "text",
        ...
        function regTel(_uid, _tel) {
            var url = "h5/share/commit?userId=" + _uid + "&shareType=2&commitType=-1&commitTel=" + _tel;
            $.ajax({
                url: url,
                type: "GET",
                success: function (data) {
