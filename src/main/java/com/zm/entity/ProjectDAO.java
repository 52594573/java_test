...
public class ProjectDAO {
	...
	public static final String _PCITY = "PCity";
	public static final String _PPRINCIPAL = "PPrincipal";
	public static final String _PCONTENT = "PContent";
	public static final String _PLOGO = "PLogo";
	public static final String IS_DEL = "isDel";
	public static final String _PSTATE = "PState";
	public static final String _PZB = "PZb";
	public static final String _PKFS = "PKfs";
	...
	public List findByExample(Project instance) {
		...
		try {
			List results = getCurrentSession()
					.createCriteria("com.zm.entity.Project")
	...
	public List findByPCity(Object PCity) {
		return findByProperty(_PCITY, PCity);
	}

	public List findByPPrincipal(Object PPrincipal) {
		return findByProperty(_PPRINCIPAL, PPrincipal);
	}
	...
	public List findByPLogo(Object PLogo) {
		return findByProperty(_PLOGO, PLogo);
	}
	...
	public List findByPZb(Object PZb) {
		return findByProperty(_PZB, PZb);
	}

	public List findByPKfs(Object PKfs) {
		return findByProperty(_PKFS, PKfs);
	}
