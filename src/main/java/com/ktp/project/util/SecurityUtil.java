...
//    private static final String PASSWORD = "46EBA22EF5204DD5B110A1F730513965"; // 加密秘钥-测试环境
//    private static final String PASSWORD = "RTI0NUVENkM1OTAyMDgxRjNGQkZDN0UxOUI2OTJGQjU";// 加密秘钥-正式环境
     ...
     * @return 密文
     */
    public String encryptAES(String content) throws ParamException {
     ...
     * @return 明文
     */
    public String decryptAES(String encryptResultStr) throws ParamException {
...
//     * 测试
//     */
//    private static void express() throws ParamException {
