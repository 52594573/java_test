...
public class HttpsUtil {
    ...
    private static HttpsURLConnection getHttpsURLConnection(String uri, String method) throws IOException {
        ...
        SSLSocketFactory ssf = ctx.getSocketFactory();    //取得SSL工厂
    ...
    public static void main(String[] args) throws IOException {
        //String uri = "https://ss3.baidu.com/-rVXeDTa2gU2pMbgoY3K/it/u=229445282,848378121&fm=202&mola=new&crop=v1";
        String uri = "https://api.mch.weixin.qq.com/pay/refundquery";
