...
@Service("gsxAuthRealNameService")
@Transactional
@SuppressWarnings("all")
public class GsxAuthRealNameService implements AuthRealNameApi {

    private static final Logger log = LoggerFactory.getLogger(GsxAuthRealNameService.class);
...
//        String url = RealNameConfig.GSX_KAOQIN_URL;
        ProjectEnum projectEnum = EnumMap.projectEnumMap.get(projectId);
        String url = projectEnum.getBaseRequest() + RealNameConfig.GSX_KAOQIN_URL;
