...
@Service("qzAuthRealNameService")
@Transactional
@SuppressWarnings("all")
public class QzAuthRealNameService implements AuthRealNameApi {

    private static final Logger log = LoggerFactory.getLogger(QzAuthRealNameService.class);
    ...
    public void synWorkerAttendance(Integer projectId, Integer kaoQinId) {
        ...
        String url = projectEnum.getBaseRequest() + RealNameConfig.QZP_KAOQIN_URL;
